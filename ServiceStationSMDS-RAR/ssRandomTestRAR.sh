...
initials=AMD
#exe=./ServiceStationAMD
file_prefix="ss"
test_count=9
out_file="otherRandomTestResults.txt"
...
#Main procedure:
g++ -fprofile-arcs -ftest-coverage ServiceStationAMD.cpp -o ServiceStationAMD 
#rm ServiceStationRAR.o
rm $out_file
echo "+++ServiceStationAMD Test Run+++" >> $out_file
echo "Testing the file ServiceStationAMD.cpp" >> $out_file
echo "" >> $out_file
